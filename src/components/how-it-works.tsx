...
export function HowItWorks() {
  return (
    <section id="process" className="border-b border-(--border-soft) bg-(--page) py-16 sm:py-20" data-reveal>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          {steps.map((step, index) => (
            <article key={step.number} className="rounded-4xl border border-(--border) bg-(--surface) p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] transition duration-300 hover:scale-[1.02]" data-reveal data-reveal-delay={String(index + 1)}>
